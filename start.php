...
<html>
<head>
<title>Leibniz-Gymnasium-Östringen</title>
		...
		<div class="head-top">
			...
			<div class="login">
				<ul class="nav-login">
					...
					<li><a href="#" data-toggle="modal" data-target="#myModal2">Registrierung</a></li>
				</ul>
			</div>
							...
							<div class="login-grids">
									...
									<div class="login-right">
										<form action="#" method="post">
											<h3>Login mit Account </h3>
											<input type="text" value="Email Adresse" name=" Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email Adresse';}" required="">	
											<input type="password" value="Passwort" name="Passwort" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Passwort';}" required="">	
											<h4><a href="#">Passwort vergessen</a> / <a href="#">Neues Passwort</a></h4>
											<div class="single-bottom">
												<input type="checkbox"  id="brand" value="">
												<label for="brand"><span></span>Daten speichern.</label>
											</div>
											<input type="submit" value="LOGIN" >
										</form>
									</div>
									
								<p>Durchs Einloggen stimmen Sie unseren <span>Terms and Conditions</span> und <span>Privacy Policy</span> zu</p>
							</div>
						</div>
					</div>
				</div>
